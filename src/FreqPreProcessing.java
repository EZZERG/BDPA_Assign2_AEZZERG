...
public class FreqPreProcessing extends Configured implements Tool {

	private static final Logger LOG = Logger
			.getLogger(FreqPreProcessing.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new FreqPreProcessing(), args);
		System.exit(res);
	}

	public int run(String[] args) throws Exception {

		Job job = Job.getInstance(getConf(), "FreqPreProcessing");
